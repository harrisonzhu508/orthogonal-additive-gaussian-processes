...
for (tree_name in tree_names) {
    ...
    for (coord_method in coord_methods) {
        ...
        spline_path <- file.path(
            "speech_phylo/final_phyloregression_results",
            paste0("spline_surface_secondorder_", tree_name, "_", coord_method, ".csv")
        )
        ...
        # Includes 2nd order interactions only (no 3rd order)
        ...
        # Also compute aggregated linear proportion (sum of Shapley terms)
        ...
        samples_path <- file.path(
            "speech_phylo/final_phyloregression_results",
            paste0("variance_samples_secondorder_", tree_name, "_", coord_method, ".csv")
        )
        ...
        coef_samples_path <- file.path(
            "speech_phylo/final_phyloregression_results",
            paste0("coef_samples_secondorder_", tree_name, "_", coord_method, ".csv")
        )
        ...
        csv_path <- file.path(
            "speech_phylo/final_phyloregression_results",
            paste0("phylolm_with_inventory_secondorder_", tree_name, "_", coord_method, ".csv")
        )
